<section class="page-content">
    ...
    <?php get_template_part("produtos/content-banner-principal", get_post_field('post_name', get_post())); ?>
    ...
    <div class="container ">
        ...
        <div class="text-default js-scroll fade-in-bottom">
            <?php get_template_part(sprintf("produtos/%s/content", get_post_field('post_name', get_post())), "priority"); ?>
        </div>
    ...
    <div class="bg-azul">
        ...
        <?php get_template_part("produtos/content-itens"); ?>

        <?php get_template_part(sprintf("produtos/%s/content-11", get_post_field('post_name', get_post()))); ?>


        <?php get_template_part(sprintf("produtos/content-slider-videos", get_post_field('post_name', get_post()))); ?>




        <?php get_template_part(sprintf("produtos/%s/content-12", get_post_field('post_name', get_post()))); ?>
    ...
    <div class="js-scroll fade-in-bottom">
        <?php get_template_part("produtos/content-10"); ?>
    </div>



    <div class="container ">
        <?php get_template_part("orcamento/content"); ?>
