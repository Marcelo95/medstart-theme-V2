	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				...
				$atts['class']         = 'nav-link d-inline-flex';
				$atts['id']            = 'menu-item-dropdown-' . $item->ID;

				$item->title = $item->title .'<a class="span-toggle d-inline-flex" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><span class="span-dropdown-toggle dropdown-toggle d-inline-flex align-items-center justify-content-center"></span></a>';
			} else {
